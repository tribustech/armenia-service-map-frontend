...
export default function AdminNeedsMapPage() {
  ...
  const columns: ColumnDef<NeedReport, unknown>[] = [
    ...
    },
    {
      ...
      header: '',
      cell: ({ row }) => (
        <Link href={`/admin/needs/${row.original.id}`} className="text-sm text-blue-600 hover:underline">
          Open
        </Link>
      ),
    },
    ...
    <div>
      ...
      <div className="mt-8 rounded-lg border bg-white">
        <div className="flex items-center justify-between p-4 pb-0">
          <h2 className="text-lg font-semibold text-gray-900">Need reports list</h2>
          <Input
